  ...
  return (
    <div className="flex flex-col gap-2 rounded-lg bg-violet-50 px-4 py-5 lg:gap-4 dark:bg-zinc-800">
      ...
      <div className="space-x-3">
        <button
          className="tex-sm font-medium text-violet-500 hover:text-violet-700 dark:text-violet-300 dark:hover:text-violet-200"
          type="button"
        >
          Dismiss
        </button>
        <button
          className="tex-sm font-medium text-violet-700 hover:text-violet-900 dark:text-zinc-300 dark:hover:text-zinc-100"
          type="button"
        >
          Upgrade plan
        </button>
